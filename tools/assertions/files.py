...
from clients.files.files_schema import CreateFileRequestSchema, FileResponseSchema, GetFileResponseSchema
...
def assert_get_file_response(
        ...
        create_file_response: FileResponseSchema
):
    """
...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Функция для проверки ошибки, если введен некорректный file_id.
